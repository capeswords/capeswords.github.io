...
* *bogen*: cut forward to schnitt from wacht, then rotate wrist [left, right] so blade is pointing down. (can point anywhere from 45 degrees down to straight down) 
...
* *eber*: right hand by right hip, blade parallel to floor point at oppoenent, left hand protecting the heart. #ThurstingGuard
...
To Thrust: go from a #ThurstingGuard to langort
...
![Plates]({{ site.baseurl }}/images/dussack_A.jpg)
